...
echo "docker compose exec structalert python -m structalert weekly-sync-now --config /opt/structalert/config/config.yml"
echo "docker compose exec structalert python -m structalert archive-sync-now --config /opt/structalert/config/config.yml"
echo "=========================================="
